...
// ==========================================
const dictionaries = {
    // کاراکترهای استاندارد Base64 (جهت نگاشت)
    base64: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(''),

    // اصلاح شده: حذف حروف انگلیسی و جایگزینی با حروف صحیح فارسی (۶۴ کاراکتر یکتا)
    farsiChars: [
    ...
    // اصلاح شده: لیست کامل و بدون تکرار ایموجی‌ها (۶۴ عدد)
    emoji: ["😀","😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","😉","😊","😇","🥰","😍","🤩","😘","😗","☺","😚","😙","🥲","😋","😛","😜","🤪","😝","🤑","🤗","🤭","🤫","🤔","🤐","🤨","😐","😑","😶","😏","😒","🙄","😬","🤥","😌","😔","😪","🤤","😴","😷","🤒","🤕","🤢","🤮","🤧","🥵","🥶","🥴","😵","🤯","🤠","🥳","😎","🤓","🧐","😕"],
...
// اطلاعات دقیق هر روش (اصلاح: حذف ایموجی‌های تکراری ⚠️ از متن‌ها)
const methodDetails = {
    ...
    farsiWords: { text: "تبدیل به جملات فارسی بی‌معنی (مثل: سیب درخت آسمان). برای ربات‌های فیلترینگ کاملا طبیعی به نظر می‌رسد.", warn: "حجم پیام نهایی کمی زیاد می‌شود." },
    invisible: { text: "جادوی سیاه! پیام شما داخل یک متن عادی مخفی می‌شود و اصلا دیده نمی‌شود. عالی برای توییتر/اینستاگرام.", warn: "هشدار مهم: حجم کاراکتر مخفی بسیار بالاست (هر حرف = ۴ کاراکتر مخفی). در پیامک استفاده نکنید." },
    ...
    chinese: { text: "کاراکترهای چینی. فشرده‌ترین حالت نمایش بعد از Base64.", warn: "ممکن است در برخی گوشی‌های قدیمی نمایش داده نشود." },
...
function updateMethodInfo() {
    ...
    if (info.warn) {
        ...
        warnText.innerText = info.warn; // اینجا دیگر ایموجی اضافه ندارد
    } else {
...
function checkStrength() {
    ...
    const speed = 10000000000n; // فرض: ۱۰ میلیارد تست در ثانیه
